...
@property (nonatomic, strong) RAlertView *previousAlert;
...
@property (nonatomic, weak) RAlertView *alertView;
...
+ (void)showOneButtonWithTitle:(NSString *)title Message:(NSString *)message ButtonType:(JCAlertViewButtonType)buttonType ButtonTitle:(NSString *)buttonTitle Click:(clickHandle)click{
    RAlertView *alertView = [RAlertView new];
...
- (void)show{
    ...
    RAlertView *previousAlert = [jCSingleTon shareSingleTon].previousAlert;
    if (previousAlert) {
...
- (void)setButton:(UIButton *)btn BackgroundWithButonType:(JCAlertViewButtonType)buttonType {
    ...
    switch (buttonType) {
        case JCAlertViewButtonTypeDefault:
            normalImage = [UIImage imageNamed:@"RAlertView.bundle/default_nor"];
            highImage = [UIImage imageNamed:@"RAlertView.bundle/default_high"];
            textColor = JCColor(255, 255, 255);
            break;
        case JCAlertViewButtonTypeCancel:
            normalImage = [UIImage imageNamed:@"RAlertView.bundle/cancel_nor"];
            highImage = [UIImage imageNamed:@"RAlertView.bundle/cancel_high"];
            textColor = JCColor(255, 255, 255);
            break;
        case JCAlertViewButtonTypeWarn:
            normalImage = [UIImage imageNamed:@"RAlertView.bundle/warn_nor"];
            highImage = [UIImage imageNamed:@"RAlertView.bundle/warn_high"];
            textColor = JCColor(255, 255, 255);
            break;
    }
...
- (void)stackHandle {
    ...
    RAlertView *lastAlert = [jCSingleTon shareSingleTon].alertStack.lastObject;
